...
function rightsAll(){
  return `<p class="note" style="margin:0 0 7px">저작권은 <b>표현</b>을 보호하고
    ...
    <p class="note" style="margin:0 0 7px"><b>헷갈리기 쉬운 것 하나</b> —
    <b>「라오에 따르면」처럼 이름을 밝히는 것 자체는 저작권 문제가 아닙니다.</b>
    오히려 위험을 <b>줄이는</b> 쪽입니다. 저작권이 요구하는 것은
    <b>남의 문장을 베낄 때의 허락</b>이지 출처 표시가 아닙니다.
    출처 표시 의무(저작권법 제37조)는 <b>「인용」 예외(제28조)에 기댈 때</b> 따라붙는 조건이라,
    문장을 안 가져오고 사실만 쓰면 그 의무 자체가 생기지 않습니다.<br>
    그리고 이 앱의 상당 부분은 <b>업계 통용 지식</b>입니다 —
    승온율이 끝까지 줄어야 한다, 감량률 밴드, 크랙을 승온율 골로 잡는 것.
    특정인의 것이 아닙니다. 그래도 이름을 적어 둔 이유는 법 때문이 아니라
    <b>「이 숫자를 얼마나 믿어야 하는가」가 이 앱의 핵심</b>이기 때문이고,
    「부드러운 / 급한 크래시」처럼 <b>한 사람의 고유한 틀</b>인 것은
    밝히지 않으면 우리가 지어낸 것처럼 보이기 때문입니다.</p>`
